...
[![hexlet-check](https://github.com/MetaSveta/python-project-83/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/MetaSveta/python-project-83/actions)
...
```bash
git clone https://github.com/MetaSveta/python-project-83.git
